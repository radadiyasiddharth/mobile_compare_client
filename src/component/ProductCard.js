  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-xl border border-gray-300">
      <Link to={`/productdescription/${data._id}`}>
        <img
          className="w-full bg-opacity-20  bg-[#7a95a2] object-cover rounded-t-lg"
          src={data.productImage} // Keep this if you have product images
          alt={data.model}
        />
      </Link>
      <div className="flex flex-col flex-grow p-4 bg-gray-50">
        ...
        <p className="text-gray-600 mb-3">
          <strong>Processor:</strong> {data.features.processor}
        </p>
        <p className="text-gray-600 mb-3">
          <strong>Camera:</strong> {data.features.camera}
        </p>
        <p className="text-gray-600 mb-3">
          <strong>Memory:</strong> {data.features.memory}
        </p>
        <p className="text-gray-600 mb-3">
          <strong>Storage:</strong> {data.features.storage}
        </p>
        <p className="text-gray-600 mb-3">
          <strong>OS:</strong> {data.features.os}
        </p>
        <p className="text-gray-600 mb-3">
          <strong>Rating:</strong> {data.features.rating} / 5
        </p>
        <div className="flex justify-between items-center mt-auto">
          <span className="text-red-600 font-semibold text-lg">
            ${data.price}
